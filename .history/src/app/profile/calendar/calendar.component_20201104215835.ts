  ...
  handleDateClick(arg) {
    ...
    if (x !== undefined && x.isAvailable ) {
      ...
      this.alerts.push({
        ...
        type: 'success',
        strong: 'Success!',
        message: `This date, ${arg.strDate}, for ${this.selecteLocation.Location} is free.`,
        icon: 'ni ni-like-2'
      });
      ...
      this.alerts.push({
        ...
        type: 'danger',
        strong: 'Notice!',
        message: `This date, ${arg.strDate}, for ${this.selecteLocation.Location} is already full. Please choose another date.`,
        icon: 'ni ni-like-2'
      });
    }
  }
