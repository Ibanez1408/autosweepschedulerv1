...
export class CalendarComponent implements OnInit, OnDestroy {
  ...
  handleDateClick(arg) {
    ...
    if (x !== undefined && x.isAvailable ) {
      this.alertString = `This date for ${this.selecteLocation.Location} is free.`;
    } else {
      this.alertString = `This date for ${this.selecteLocation.Location} is already full. Please choose another date.`;
    }
  }
