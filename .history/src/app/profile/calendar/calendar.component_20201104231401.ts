    ...
    this.as.queryAvailability(this.selectedDate, this.selectedLocation.Location).subscribe((data: any) => {
      ...
      if (data.success) {
        const schedule: Schedule = {
          ...
          appointmentTime: formValues.get('appointmentTime').value,
          completeName: formValues.get['completeName'].value,
          emailAddres: formValues.get['emailAddress'].value,
          location: this.selectedLocation.Location,
          plateNo: formValues.get['plateNumber'].value,
          vehicleClassId: formValues.get['vehicleClassId'].value
        };
        this.as.sendSchedule(schedule).subscribe((data1: any) => {
          if (data1.success) {
            ...
            this.alerts.push({
              ...
              type: 'success',
              strong: 'Ok!',
              message: `Your schedule was successfully submitted. Thank you.`,
              icon: 'ni ni-like-2'
            });
          }
        })
