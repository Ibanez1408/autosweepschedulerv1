...
export class SheetsService {
  ...
  // });
    return this.http.post('https://cors-anywhere.herokuapp.com/https://script.google.com/macros/s/AKfycbzxzBbAmnoLwHEy9xMg7h0ryFYN5_OJTMC6m8Qbm45okHFikAs/exec', options);
}
}
